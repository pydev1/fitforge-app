...
const s = StyleSheet.create({
  ...
  headerTitle: { fontSize: 16, color: colors.text, fontWeight: '800', letterSpacing: -0.2 },
  headerSub: { fontSize: 11, color: colors.textMuted, marginTop: 2, letterSpacing: 0.1 },
  clearBtn: {
    width: 34,
    height: 34,
    borderRadius: 17,
  ...
  quickContent: { paddingHorizontal: 14, paddingVertical: 9, gap: 8 },
  quickChip: {
